...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/177f46518b248b67ea682eaa4e7a3848b128dee1/chrome/index.d.ts
interface Window {
...
declare namespace chrome.contextMenus {
    interface OnClickData {
         ...
         * Optional.
          * Since Chrome 35.
         * Will be present for elements with a 'lib' URL.
         */
        srcUrl?: string;
    }
    ...
    interface CreateProperties {
         ...
         */
        enabled?: boolean;
        /** Optional. Similar to documentUrlPatterns, but lets you filter based on the lib attribute of img/audio/video tags and the href of anchor tags.  */
...
declare namespace chrome.documentScan {
    ...
    interface DocumentScanCallbackArg {
        /** The data image URLs in a form that can be passed as the "lib" value to an image tag. */
        dataUrls: string[];
...
declare namespace chrome.tabs {
     ...
     * @param callback
     * Parameter dataUrl: A data URL which encodes an image of the visible area of the captured tab. May be assigned to the 'lib' property of an HTML Image element for display.
     */
